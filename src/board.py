...
def create_board():
    ...
    return [
        ...
        Space (position=2, name="Comunity Chest", type=SpaceType.COMUNITY_CHEST),
        ...
        Space (position=17, name="Comunity Chest", type=SpaceType.COMUNITY_CHEST),
        ...
        Space (position=33, name="Comunity Chest", type=SpaceType.COMUNITY_CHEST),
